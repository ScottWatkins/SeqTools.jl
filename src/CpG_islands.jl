"""
    (oe, avg, cgi) = CpG_islands(positions::Array, refseq::NamedTuple)
...
"""
function CpG_islands(positions::Array, refseq::NamedTuple; window=200, step=200, noslide=false, cpg=0.6, gcavg=0.5)
